<template>
    <div class="min-h-screen bg-white flex flex-col lg:flex-row">
        <div class="lg:pt-48 w-full bg-purple-300">
            <div
                class="flex flex-col items-center px-4 py-12 sm:px-6 lg:flex-none lg:px-20 xl:px-24"
            >
                <img
                ...
                <div class="mt-6">
                    <div>
                        ...
                        <p class="mt-2 mb-3 text-sm text-gray-600 max-w">
                            Por favor, informe seu e-mail para iniciarmos o
                    ...
                    <form @submit.prevent="submit">
                        ...
                        <div class="mb-4 flex flex-col lg:flex-row gap-8">
                            <button
...
export default {
    ...
    methods: {
        submit() {
            ...
            axios.post("/api/forgot-password", this.fields).then((response) => {
                    this.message =
