    ...
    <div class="w-full h-full bg-white ">
      <div class="h-[50px] bg-gray-100 flex items-center shadow-sm px-[20px] w-full py-[10px] z-10 border-b" >
        ...
        <div class="w-[calc(100%-30px)] flex ">
          ...
          <!-- User login -->
          <div class="w-[200px] cursor-pointer rounded-md border-gray-900 hover:bg-gray-300 hover:text-gray-800 transition duration-400 ease-in-out">
            <div class="flex items-center justify-start space-x-4  mx-3 " @click="toggleDrop">
